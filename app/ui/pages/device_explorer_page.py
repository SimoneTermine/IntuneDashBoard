...
class DeviceExplorerPage(QWidget):
    ...
    def _setup_ui(self):
        ...
        self._compliance_filter.addItems(["All States", "compliant", "noncompliant", "unknown", "error"])
        ...
        self._ownership_filter.addItems(["All Ownership", "company", "personal", "unknown"])
        ...
        for w in [QLabel("State:"), self._compliance_filter,
    ...
    def _export(self):
        ...
        try:
            ...
            QMessageBox.information(self, "Export Complete", f"Devices exported to:\n{path}")
